...
void CircleShape::draw(QPainter &painter) const override {
...
void CircleShape::setStartPoint(const QPoint &point) override {
    startPoint = point;
}

void CircleShape::setEndPoint(const QPoint &point) override {
    endPoint = point;
}
